...
#define PROXIMITY_LIGHT_DATA_SIZE 6
            ...
            //fixed4 frag(v2f i, fixed facing : VFACE) : SV_Target //Old Version - was causing error: https://github.com/microsoft/MixedRealityToolkit-Unity/issues/5844
...
#endif
#else
                //Commented out due to https://github.com/microsoft/MixedRealityToolkit-Unity/issues/5844
                //worldNormal = normalize(i.worldNormal) * facing;
                worldNormal = normalize(i.worldNormal) * 1; //Substitute for "facing" above
#endif
#endif
